...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Predicate<Widget> zeroOrGreater = obj -> obj.getValue() >= 0;
        ...
        UnaryOperator<Widget> nameToLower = obj -> {
            String temp = obj.getName().toLowerCase();
            obj.setName(temp);
            return obj;
        };
        ...
        // This code should be written on a single line.
        Consumer<Widget> print = obj -> System.out.println(obj.toString());
